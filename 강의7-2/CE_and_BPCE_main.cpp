...
//
//int main() {
//	CommissionEmployee commissionEmploee{
...
//
//	cout << "DISPLAY BASE-CLASS AND DERIVED-CLASS OBJECT:\n"
//		<< commissionEmploee.toString()
//		<< "\n\n"
//		<< basePlusCommissionEmployee.toString();
//
//	CommissionEmployee* commissionEmployeePtr{ &commissionEmploee };
